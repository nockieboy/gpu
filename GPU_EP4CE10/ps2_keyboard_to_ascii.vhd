            ...
            ELSE --if control keys are not pressed  
              ...
              IF(shift_l = '1' OR shift_r = '1') THEN  --key's secondary character is desired
                CASE ps2_code IS              
                  ...
                  WHEN x"1E" => ascii <= x"22"; --" should be --@
                  WHEN x"26" => ascii <= x"27"; --# should be --£
                  ...
                  WHEN x"52" => ascii <= x"40"; --@ should be --"
                  WHEN x"36" => ascii <= x"5E"; --^
                  WHEN x"4E" => ascii <= x"5F"; --_
                  WHEN x"54" => ascii <= x"7B"; --{
                  WHEN x"5D" => ascii <= x"7E"; --| should be --~
                  WHEN x"5B" => ascii <= x"7D"; --}
                  WHEN x"0E" => ascii <= x"7C"; --~ should be --|
                  WHEN OTHERS => NULL;
                END CASE;
              ELSE                                     --key's primary character is desired
                CASE ps2_code IS  
                  ...
                  WHEN x"5D" => ascii <= x"23"; --\ should be --#
