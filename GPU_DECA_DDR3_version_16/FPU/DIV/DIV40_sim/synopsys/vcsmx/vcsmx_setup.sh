...
TOP_LEVEL_NAME="DIV40"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="D:/fpga/quartus20-1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/DIV40_memoryC0_uid146_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/DIV40_memoryC0_uid147_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/DIV40_memoryC0_uid148_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/DIV40_memoryC1_uid151_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/DIV40_memoryC1_uid152_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/DIV40_memoryC2_uid155_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/DIV40_memoryC2_uid156_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/DIV40_memoryC3_uid159_invTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/DIV40.vo"
fi
