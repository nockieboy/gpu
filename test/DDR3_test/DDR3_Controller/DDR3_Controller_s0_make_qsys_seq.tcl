...
lappend arg_list "--component-param=SEQUENCER_VERSION=20.1"
...
lappend arg_list "--component-param=SEQUENCER_MEM_SIZE=19456"
...
catch { eval [concat [list exec "G:/altera/20.1/quartus//sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
