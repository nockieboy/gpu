...
proc DDR3_Controller_p0_get_input_clk_id { pll_output_node_id } {
	if {[DDR3_Controller_p0_is_node_type_pll_clk $pll_output_node_id]} {
		...
		DDR3_Controller_p0_traverse_fanin_up_to_depth $pll_output_node_id DDR3_Controller_p0_is_node_type_pll_inclk clock results_array 2
		if {[array size results_array] == 1} {
			...
			DDR3_Controller_p0_traverse_fanin_up_to_depth $pll_inclk_id DDR3_Controller_p0_is_node_type_pin clock results_array 5
			if {[array size results_array] == 1} {
...
proc DDR3_Controller_p0_get_output_clock_id { ddio_output_pin_list pin_type msg_list_name {max_search_depth 20} } {
...
proc DDR3_Controller_p0_get_output_clock_clkbuf_id { ddio_output_pin_list pin_type msg_list_name {max_search_depth 20} } {
	upvar 1 $msg_list_name msg_list
	set output_clock_id -1
...
proc DDR3_Controller_p0_traverse_to_clock_phase_select {pin msg_list_name} {
	...
	if {$pin != ""} {
		...
		set cps_id_list [DDR3_Controller_p0_traverse_atom_path $pin_id -1 $pin_to_cps_path]
...
proc DDR3_Controller_p0_traverse_to_clkbuf {pin msg_list_name} {
	upvar 1 $msg_list_name msg_list
	set result ""
	if {$pin != ""} {
		set pin_id [get_atom_node_by_name -name $pin]
		...
		set clkbuf_id_list [DDR3_Controller_p0_traverse_atom_path $pin_id -1 $pin_to_clkbuf_path]
...
# ----------------------------------------------------------------
	...
	if {$pin_report_id != -1} {
		set pin_name_column [DDR3_Controller_p0_get_report_column $pin_report_id "Pin Name/Usage"]
		set info_column [DDR3_Controller_p0_get_report_column $pin_report_id "I/O Type"]
		if {$pin_name_column == 0 && 0} {
			set row_index [get_report_panel_row_index -id $pin_report_id $target_pin]
			if {$row_index != -1} {
				set row [get_report_panel_row -id $pin_report_id -row $row_index]
		...
		if {$pin_report_id != -1} {
			...
			set report_rows [get_number_of_rows -id $pin_report_id]
			set pin_name_column [DDR3_Controller_p0_get_report_column $pin_report_id "Name"]
			set info_column [DDR3_Controller_p0_get_report_column $pin_report_id "I/O Edge"]
...
proc DDR3_Controller_p0_get_dqs_period { dqs_pins } {
	set dqs_period -100
	set dqs0 [lindex $dqs_pins 0]
	if {$dqs0 != ""} {
		set dll_id [DDR3_Controller_p0_traverse_to_dll_id $dqs0 msg_list]
		if {$dll_id != -1} {
...
proc DDR3_Controller_p0_get_ddr_pins { instname allpins } {
	...
	# AFI CLOCK PLL
	set pll_afi_clock_id [DDR3_Controller_p0_get_output_clock_id $pins(afi_ck_pins) "AFI CK" msg_list]
	if {$pll_afi_clock_id == -1} {
		foreach {msg_type msg} $msg_list {
			post_message -type $msg_type "DDR3_Controller_p0_pin_map.tcl: $msg"
		}
		post_message -type critical_warning "DDR3_Controller_p0_pin_map.tcl: Failed to find PLL clock for pins [join $pins(afi_ck_pins)]"
	} else {
		set pll_afi_clock [DDR3_Controller_p0_get_pll_clock_name $pll_afi_clock_id]
	}
	set pins(pll_afi_clock) $pll_afi_clock

	# AFI PHY CLOCK PLL
	set pll_afi_phy_clock_id [DDR3_Controller_p0_get_output_clock_id $pins(afi_phy_ck_pins) "AFI PHY CK" msg_list]
	if {$pll_afi_phy_clock_id == -1} {
		foreach {msg_type msg} $msg_list {
			post_message -type $msg_type "DDR3_Controller_p0_pin_map.tcl: $msg"
		}
		post_message -type critical_warning "DDR3_Controller_p0_pin_map.tcl: Failed to find PLL clock for pins [join $pins(afi_phy_ck_pins)]"
	} else {
		set pll_afi_phy_clock [DDR3_Controller_p0_get_pll_clock_name $pll_afi_phy_clock_id]
	}
	...
	set pll_avl_clock_id [DDR3_Controller_p0_get_output_clock_id $pins(avl_ck_pins) "Avalon Bus CK" msg_list]
	if {$pll_avl_clock_id == -1} {
		foreach {msg_type msg} $msg_list {
			post_message -type $msg_type "DDR3_Controller_p0_pin_map.tcl: $msg"
		}
		post_message -type critical_warning "DDR3_Controller_p0_pin_map.tcl: Failed to find PLL clock for pins [join $pins(avl_ck_pins)]"
	} else {
		set pll_avl_clock [DDR3_Controller_p0_get_pll_clock_name $pll_avl_clock_id]
	}
	set pins(pll_avl_clock) $pll_avl_clock


	set pll_config_clock_id [DDR3_Controller_p0_get_output_clock_id $pins(config_ck_pins) "Config CK" msg_list]
	if {$pll_config_clock_id == -1} {
		foreach {msg_type msg} $msg_list {
			post_message -type $msg_type "DDR3_Controller_p0_pin_map.tcl: $msg"
		}
		post_message -type critical_warning "DDR3_Controller_p0_pin_map.tcl: Failed to find PLL clock for pins [join $pins(config_ck_pins)]"
	} else {
		set pll_config_clock [DDR3_Controller_p0_get_pll_clock_name $pll_config_clock_id]
	}
...
proc DDR3_Controller_p0_dump_static_pin_map { ddr_db_par filename } {
	...
	foreach instname $instnames {
		...
		DDR3_Controller_p0_static_map_expand_string $FH pins pll_afi_phy_clock
		...
		DDR3_Controller_p0_static_map_expand_string $FH pins pll_avl_clock
		DDR3_Controller_p0_static_map_expand_string $FH pins pll_config_clock
