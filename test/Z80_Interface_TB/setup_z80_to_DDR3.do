...
vlog -sv -work work {BrianHG_DDR3/BrianHG_DDR3_COMMANDER.sv}
vlog -sv -work work {BrianHG_DDR3/BrianHG_DDR3_CONTROLLER_top.sv}
...
add wave -hexadecimal /Z80_Bus_Interface_to_DDR3_tb/CMD_R_busy 
add wave -hexadecimal /Z80_Bus_Interface_to_DDR3_tb/CMD_read_req 
add wave -hexadecimal /Z80_Bus_Interface_to_DDR3_tb/CMD_raddr 
...
add wave -hexadecimal /Z80_Bus_Interface_to_DDR3_tb/CMD_W_busy 
add wave -hexadecimal /Z80_Bus_Interface_to_DDR3_tb/CMD_write_req 
add wave -hexadecimal /Z80_Bus_Interface_to_DDR3_tb/CMD_waddr 
