...
module TEST_DDR3_example_d0 #(
		...
		output wire [27:0] avl_addr,        //          .address
	...
	generate
		...
		if (DRIVER_SIGNATURE != 1431634121)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
