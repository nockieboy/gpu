...
lappend arg_list "--report-file=csv:TEST_DDR3_example.csv"
lappend arg_list "--report-file=qip:TEST_DDR3_example.qip"
lappend arg_list "--output-name=TEST_DDR3_example"
...
catch { eval [concat [list exec "G:/altera/20.1/quartus//sopc_builder/bin/ip-generate" --component-name=alt_mem_if_ddr3_tg_ed] $arg_list] } temp
puts $temp
